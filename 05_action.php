...
if ($act=='sys_pull_master') {
	...
	echo "<pre>$output</pre>";
     ...
     $sql_save = "UPDATE $dbname.sm10_set SET smartm_software_version=6; ";
   ...
   mysqli_multi_query($con,$sql_save); 
    ...
    $sql_save = "INSERT INTO $dbname.sm10_set (create_date, update_date, last_access_date, journal_id, help_shown, theme_type, smartm_software_version) VALUES (NOW(), NOW(), NOW(),1,0,0,6); ";
     mysqli_multi_query($con,$sql_save);
