...
$(document).ready(function() {
    ...
    function addSplity(){
        ...
        let btnRemoveSplity = "<button type='button' class='btn btn-outline-dark btnRemoveSplity' value='"+splityId+"'>-</button>"
            ...
            <tr id='areaSplit'><td colspan='2'>
                ...
                <table class='table' id='splityTable'>
                    ...
                    <tr>
                        ...
                        <td><button type='button' class='btn btn-outline-dark float-right' id='addSplity'>+</button></td>
                    </tr>
