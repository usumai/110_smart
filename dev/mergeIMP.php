...
$capableOfFF        = false;
fnMerge($tableName, $stkm_id_one, $stkm_id_two, $pkName, $storageIDName, $sqlFilter, $capableOfFF);



function fnMerge($tableName, $stkm_id_one, $stkm_id_two, $pkName, $storageIDName, $sqlFilter, $capableOfFF){
    $qar    = [];
    $rows   = "";
