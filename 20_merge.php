...
let merge = {
    ...
    6:{ config:[1,1,1,1],act:"Compare",
        desc:"	Both stocktakes have a record of this, and both have a result for it. <br> E.1: Both fingerprints are the same = Use stocktake 1 <br> E.2: Fingerprints are different = Offer the user the chance to deconflict"
    },
